...
class TelaPrincipal(BoxLayout):
    ...
    def obter_pasta_pdf(self):
        ...
        for download in candidatos:

            try:

                if os.path.isdir(download) and os.access(
                    download,
                    os.W_OK
                ):

                    pasta_harmonia = os.path.join(
                        download,
                        "Harmonia Avançada"
                    )
                    ...
                    try:
                        ...
                        if (
                            os.path.isdir(pasta_harmonia)
                            and
                            os.access(pasta_harmonia, os.W_OK)
                        ):
                            return pasta_harmonia
                    ...
                    # ====================================================
                    # SEGUNDA OPÇÃO:
                    # Se o Android não permitir criar a subpasta,
                    # salva diretamente na pasta Download.
                    # ====================================================

                    try:

                        teste_download = os.path.join(
                            download,
                            ".triades_teste"
                        )
                        ...
                        with open(
                            ...
                            arquivo_teste.write("TRIADES")

                        os.remove(teste_download)
        ...
        # ====================================================
        # ÚLTIMO RECURSO:
        # pasta privada do aplicativo
        # ====================================================

        pasta_privada = os.path.join(
